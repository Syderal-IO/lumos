...
const dictionaries = {
  es: {
    ...
    "landing.hero_sub_1": "Vende tu excedente solar a tus vecinos.",
    "landing.hero_sub_2": "Pagos instantáneos en USDC. Sin intermediarios.",
    "landing.cta_sell": "Comenzar a Vender",
    ...
    "landing.problem_desc": "En Latinoamérica, los hogares con paneles solares pierden hasta el 40% de su energía generada porque no pueden venderla eficientemente.",
    "landing.problem_1": "Los excedentes solares se pierden o se venden a precios mínimos a la red eléctrica",
    "landing.problem_2": "No existe un mercado peer-to-peer accesible para comunidades residenciales",
    ...
    "landing.solution_desc": "Lumos conecta prosumidores solares con compradores en su vecindario, usando IA conversacional y pagos instantáneos on-chain.",
    "landing.solution_1": "Agente de IA que detecta excedente y ejecuta ventas automáticamente",
    "landing.solution_2": "Pagos instantáneos en USDC vía smart contracts en Solana",
    "landing.solution_3": "Marketplace descentralizado, transparente y sin comisiones abusivas",
    // Key Features
    "landing.features_badge": "CARACTERÍSTICAS",
    "landing.features_title": "Todo lo que necesitas para vender energía",
    "landing.feat_1_title": "Agente IA Solei",
    "landing.feat_1_desc": "Un agente conversacional que analiza tu producción, encuentra compradores y ejecuta ventas con tu aprobación.",
    "landing.feat_2_title": "Smart Contracts",
    "landing.feat_2_desc": "Escrow NexusVault en Solana que garantiza pagos seguros e instantáneos entre prosumidor y comprador.",
    ...
    "landing.feat_5_desc": "Estadísticas detalladas de producción, ventas, ingresos y predicciones con machine learning.",
    "landing.feat_6_title": "Pagos USDC",
    "landing.feat_6_desc": "Sin volatilidad. Recibe pagos en stablecoin directamente en tu wallet. Fee del 0.001%.",
    // Team
  ...
  en: {
    ...
    "landing.hero_sub_1": "Sell your solar surplus to your neighbors.",
    "landing.hero_sub_2": "Instant payments in USDC. No middlemen.",
    "landing.cta_sell": "Start Selling",
    ...
    "landing.problem_desc": "In Latin America, households with solar panels lose up to 40% of their generated energy because they can't sell it efficiently.",
    "landing.problem_1": "Solar surplus is lost or sold at minimal prices to the utility grid",
    "landing.problem_2": "No accessible peer-to-peer marketplace exists for residential communities",
    "landing.problem_3": "Payments are slow, opaque, and depend on centralized intermediaries",
    "landing.solution_title": "The Solution",
    "landing.solution_desc": "Lumos connects solar prosumers with buyers in their neighborhood using conversational AI and instant on-chain payments.",
    "landing.solution_1": "AI agent that detects surplus and executes sales automatically",
    "landing.solution_2": "Instant USDC payments via smart contracts on Solana",
    "landing.solution_3": "Decentralized, transparent marketplace with minimal fees",
    // Key Features
    "landing.features_badge": "FEATURES",
    "landing.features_title": "Everything you need to sell energy",
    "landing.feat_1_title": "Solei AI Agent",
    "landing.feat_1_desc": "A conversational agent that analyzes your production, finds buyers, and executes sales with your approval.",
    "landing.feat_2_title": "Smart Contracts",
    "landing.feat_2_desc": "NexusVault escrow on Solana that guarantees secure and instant payments between prosumer and buyer.",
    ...
    "landing.feat_5_desc": "Detailed statistics on production, sales, income, and predictions with machine learning.",
    "landing.feat_6_title": "USDC Payments",
    "landing.feat_6_desc": "No volatility. Receive payments in stablecoin directly to your wallet. 0.001% fee.",
    // Team
